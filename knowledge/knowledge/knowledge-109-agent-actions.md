---
id: knowledge-109-agent-actions
title: Agent Actions
kind: knowledge
tags: tools, permission
---

# Agent Actions

Agent actions should declare target, permission level, inputs, and expected output before running.

## ARIA use

- Match this file when the user asks about tools, permission.
