---
id: knowledge-103-content-security
...
A CSP limits scripts, connections, frames, and assets to trusted sources.

## ARIA use

- Match this file when the user asks about csp, browser.
