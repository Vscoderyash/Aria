---
id: working-041-api-design
title: API Design
kind: working
tags: routes, contracts
---

# API Design

API routes should return predictable JSON with error, data, and status fields.

## ARIA use

- Match this file when the user asks about routes, contracts.
